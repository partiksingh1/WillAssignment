...
export const StockComponent: React.FC<StockProps> = ({ stocks, setStocks }) => {
    ...
    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold text-black my-4">Stocks</h2>
            ...
            <button onClick={() => addStock()} className="mt-4 bg-black text-white py-2 px-4 rounded-md hover:bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
                Add Stock
            </button>
        </div>
    )
