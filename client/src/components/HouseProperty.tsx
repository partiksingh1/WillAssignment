...
interface HouseProps {
    house: Property[],
    setHouse: React.Dispatch<React.SetStateAction<Property[]>>
}
export const HouseComponent: React.FC<HouseProps> = ({ house, setHouse }) => {
    const add = () => {
    ...
    const remove = (index: number) => {
        setHouse(house.filter((_, i) => i !== index));
    };

    return (
        <div className="space-y-6">
            <h2 className="text-2xl font-bold text-black my-4">House Properties</h2>
